...
graph TD
    ...
    C --> J[司马师①]:::normal
    C --> K(司马昭②):::emperor
    C --> L[司马亮③<br>（汝南王）]:::eightWar
    C --> M[...]:::normal
    C --> Q[司马伦⑧<br>（赵王）]:::eightWar
    C --> R[司马干⑨]:::normal
    ...
    %% 第四代 - 司马泰系
    Y --> AC[司马越<br>（东海王）]:::eightWar

    %% 第五代 - 司马炎系
    AA --> AD[司马衷②<br>（晋惠帝）]:::emperor
    AA --> AE[司马玮⑤<br>（楚王）]:::eightWar
    AA --> AF[司马乂⑥<br>（长沙王）]:::eightWar
    AA --> AG[司马颖⒃<br>（成都王）]:::eightWar
    AA --> AH[...]:::normal

    %% 第五代 - 司马攸系
    Z --> AM[司马冏<br>（齐王）]:::eightWar

    %% 第五代 - 司马瓌系
    AB --> AN[司马颙<br>（河间王）]:::eightWar
...
graph TD
    ...
    classDef emperor fill:#fff1f0,stroke:#ff4d4f,stroke-width:2px;
    classDef normal fill:#f6ffed,stroke:#52c41a,stroke-width:1px;
    classDef female fill:#fff0f6,stroke:#ff85c0,stroke-width:1px;
    classDef waiqi fill:#fff7e6,stroke:#ffa940,stroke-width:1px;
    classDef queeu fill:#f9f0ff,stroke:#b37feb,stroke-width:2px;

    subgraph 平阳贾氏
        JK[贾逵<br>曹魏豫州刺史]:::normal --> JL[贾充<br>西晋太尉/鲁公]:::waiqi
        JL --> JO((贾褒<br>嫁齐王司马攸)):::queeu
        JL --> JP([贾裕]):::female
        JL --> JQ((贾南风<br>嫁晋惠帝司马衷)):::queeu
        JL --> JR([贾午]):::female
    end
    subgraph 弘农杨氏
    direction LR
        YA[杨震<br>东汉太尉]:::normal --祖父--> YD[杨众<br>亭侯]:::normal
        YD --> YE[杨炳]:::waiqi
        YE --> YF((杨艳<br>武元皇后)):::queeu
        YD --> YG[杨骏]:::waiqi
        YG --> YH((杨芷<br>武悼皇后)):::queeu
        YD --> YI[杨珧]:::normal
        YD --> YJ[杨济]:::normal
    end
